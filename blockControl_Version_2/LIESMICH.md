...
- Englisch: `EEP_Lua_Automatic_Train_Control_v2.pdf`
- Deutsch: `EEP_Lua_Automatische_Zugsteuerung_v2.pdf`
...
Zu dieser Anlage gibt es eine Variante die das Modul [BetterContacts](https://emaps-eep.de/lua/bettercontacts) von Benny verwendet.
