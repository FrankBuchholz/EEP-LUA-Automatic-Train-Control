...
--     block  1, 2, 3, 4, 5, 6
allowed[1]= {40, 1, 0, 0, 0, 1} -- 0 not allowed, 1 allowed, >1 stop time (add the drive time from sensor to signal)
allowed[2]= { 0, 0, 1,20, 1, 0}
twowayblk = { 0, 3, 2, 0, 0, 0}
blocksig  = { 8,18, 9,19,10,13}
memsig    = { 5, 6, 7,15,20,21}
